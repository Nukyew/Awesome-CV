...
\name{Zachary}{Spilinek}
\position{Full Stack Developer{\enskip\cdotp\enskip}Graphic Designer}
\address{Midvale, UT 84047}

\mobile{(703) 581-3461}
\email{zachary.spilinek@gmail.com}
\homepage{zachary.spilinek.com}
\github{Nukyew}
\linkedin{zachary-spilinek}
% \gitlab{gitlab-id}
